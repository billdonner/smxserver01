...
struct NetClientOps {
    ...
    static func xperform_get_request(_ url_to_request: String,  completion:@escaping (Int,Data?)->())
    {
    ...
    static func xperform_post_request(_ url_to_request: String, paramString: String, completion:@escaping (Int,Data?)->())
    {
        let session = URLSession.shared // doesnt work with Sm.axx.session ??
        let url:URL = URL(string: url_to_request)!
...
//struct NetClientOps {
//    /// this is good for a one shot get to anywhere
//    static func perform_get_request(schema: String, host:String, port:Int16, path:String, completion:@escaping (Int,Data?)->())
//    {
//        if appleonly {
//            let url_to_request = schema + "://" + host + ":" + "\(port)/\(path)"
//            let session = URLSession.shared // doesnt work with Sm.axx.session ??
...
//            task.resume()
//        } else {
//            // not apple - use kitur synchronous method
//
//            let data =  fetch(path, method: "GET", body: "",schema:schema,host:host,port:port)
//            completion (200, data)
//
//        }
//    }
...
//        else {
//            // not apple - use kitur synchronous method
//            let data =  fetch(path, method: "POST", body: "",schema:schema,host:host,port:port)
//            completion (200, data)
//        }
//    }
//
//    private  static func get(_ path: String, schema: String, host:String, port:Int16) -> Data? {
//        return fetch(path, method: "GET", body: "",schema:schema,host:host,port:port)
//    }
//
//    private  static func post(_ path: String, fields: [String: Any], schema: String, host:String, port:Int16) -> Data? {
//        let string = JSON(fields).rawString() ?? ""
//        return fetch(path, method: "POST", body: string,schema:schema,host:host,port:port)
//    }
//
//    private static func fetch(_ path: String, method: String, body: String, schema: String, host:String, port:Int16) -> Data? {
//        var requestOptions: [ClientRequest.Options] = []
//
//        requestOptions.append(.schema("\(schema)://"))
//        requestOptions.append(.hostname(host))
